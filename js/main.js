...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>游戏说明</div><p>游戏的基本方式是让落下的方块叠加在六边形的各个边上</p><p>" + (settings.platform != 'mobile' ? '按左右键' : '点击屏幕左右边') + " 来旋转六边形。" + (settings.platform != 'mobile' ? ' 按下键加速方块落下速度': '') + " </p><p>当三个以上相同颜色的方块连接在一起时则会被消除掉并获得分数</p><p>六边形外围不断消失的<span style='color:#f1c40f;'>五</span><span style='color:#e74c3c'>颜</span><span style='color:#3498db'>六</span><span style='color:#2ecc71'>色</span>圈表示的是连击奖励时间。</p> <hr> <p id = 'afterhr'></p> By <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> & <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a><br>Find Hextris on <a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> & <a href ='https://play.google.com/store/apps/details?id=com.hextris.hextris' target='_blank'>Android</a><br>More @ the <a href ='http://hextris.github.io/' target='_blank'>Hextris Website</a>");
	if (gameState == 1) {
		pause();
	}
